...
public abstract class Attachment
{
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            {
                event.getToolTip().add(new TranslatableComponent("perk.alloyedguns.title").withStyle(ChatFormatting.GRAY, ChatFormatting.BOLD));
            ...
            {
                addPerk(negativePerks, false, "perk.alloyedguns.fire_volume.negative");
            }
            else if(outputSound < inputSound)
            {
                addPerk(positivePerks, true, "perk.alloyedguns.fire_volume.positive");
            }
            ...
            for(IGunModifier modifier : modifiers)
            {
                ...
                {
                    addPerk(positivePerks, true, "perk.alloyedguns.silenced.positive");
                    break;
                }
            }
            ...
            {
                addPerk(negativePerks, false, "perk.alloyedguns.sound_radius.negative");
            }
            else if(outputRadius < inputRadius)
            {
                addPerk(positivePerks, true, "perk.alloyedguns.sound_radius.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.alloyedguns.additional_damage.positive", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            else if(additionalDamage < 0.0F)
            {
                addPerk(negativePerks, false, "perk.alloyedguns.additional_damage.negative", ItemStack.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            ...
            {
                addPerk(positivePerks, true, "perk.alloyedguns.modified_damage.positive");
            }
            else if(outputDamage < inputDamage)
            {
                addPerk(negativePerks, false, "perk.alloyedguns.modified_damage.negative");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.alloyedguns.projectile_speed.positive");
            }
            else if(outputSpeed < inputSpeed)
            {
                addPerk(negativePerks, false, "perk.alloyedguns.projectile_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.alloyedguns.projectile_spread.negative");
            }
            else if(outputSpread < inputSpread)
            {
                addPerk(positivePerks, true, "perk.alloyedguns.projectile_spread.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.alloyedguns.projectile_life.positive");
            }
            else if(outputLife < inputLife)
            {
                addPerk(negativePerks, false, "perk.alloyedguns.projectile_life.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.alloyedguns.recoil.negative");
            }
            else if(outputRecoil < inputRecoil)
            {
                addPerk(positivePerks, true, "perk.alloyedguns.recoil.positive");
            }
            ...
            {
                addPerk(positivePerks, true, "perk.alloyedguns.ads_speed.positive");
            }
            else if(outputAdsSpeed < inputAdsSpeed)
            {
                addPerk(negativePerks, false, "perk.alloyedguns.ads_speed.negative");
            }
            ...
            {
                addPerk(negativePerks, false, "perk.alloyedguns.rate.negative");
            }
            else if(outputRate < inputRate)
            {
                addPerk(positivePerks, true, "perk.alloyedguns.rate.positive");
            }
    ...
    {
        components.add(new TranslatableComponent(positive ? "perk.alloyedguns.entry.positive" : "perk.alloyedguns.entry.negative", new TranslatableComponent(id, params).withStyle(ChatFormatting.WHITE)).withStyle(positive ? ChatFormatting.DARK_AQUA : ChatFormatting.GOLD));
    }
}
