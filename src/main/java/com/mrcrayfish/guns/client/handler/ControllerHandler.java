...
public class ControllerHandler
{
    ...
    public void updateAvailableActions(GatherActionsEvent event)
    {
        ...
        if(player != null)
        {
            ...
            if(heldItem.getItem() instanceof GunItem)
            {
                event.getActions().put(GunButtonBindings.AIM, new Action(new TranslatableComponent("alloyedguns.action.aim"), Action.Side.RIGHT));
                event.getActions().put(GunButtonBindings.SHOOT, new Action(new TranslatableComponent("alloyedguns.action.shoot"), Action.Side.RIGHT));
                ...
                {
                    event.getActions().put(GunButtonBindings.RELOAD, new Action(new TranslatableComponent("alloyedguns.action.reload"), Action.Side.LEFT));
                }
                ...
                if(scopeStack.getItem() instanceof IScope && AimingHandler.get().isAiming())
                {
                    ...
                    if(scope.isStable())
                    {
                        event.getActions().put(GunButtonBindings.STEADY_AIM, new Action(new TranslatableComponent("alloyedguns.action.steady_aim"), Action.Side.RIGHT));
                    }
                }
            }
        }
